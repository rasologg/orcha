package io.rasolog.provisioning.connector.simcard.stream.listener;

import io.rasolog.provisioning.connector.simcard.stream.channel.MessageChannels;
...
public class MessageListeners {
    ...
    @StreamListener(value = MessageChannels.reserveSimCardConsumer)
    public void reserveSimCardConsumer(IntegrationRequest event) {
        ...
        log.info("Reserve Simcard {} for customer {}", simcardId, customerId);
        Map<String, Object> results = new HashMap<>();
        results.put("customer_id", customerId);
        results.put("simcard_id", simcardId);
        results.put("simcard_status", "RESERVED");
