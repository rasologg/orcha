package io.rasolog.provisioning.connector.crm.stream.listener;

import io.rasolog.provisioning.connector.crm.stream.channel.MessageChannels;
...
public class MessageListeners {
    ...
    @StreamListener(value = MessageChannels.notifyCustomerConsumer)
    public void notifyCustomerConsumer(IntegrationRequest event) {
        ...
        log.info("Notifying customer {}. The mobile line is active", customerId);
        Map<String, Object> results = new HashMap<>();
        results.put("customer_id", customerId);
        results.put("simcard_id", simcardId);
        results.put("provisioning_status", "COMPLETED");
